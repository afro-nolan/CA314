...
class Game:
	...
	def initialise_board(self):
		...
		s6 = Station("Busaras Dublin", False, False, 200, TitleDeedCard("Busaras Dublin", True, 200, 100, [25, 50, 100, 200], "B", None, None, None, "resources/BusarasDublin.png"), 5)
		...
		s16 = Station("Dublin Airport", False, None, 200, TitleDeedCard("Dublin Airport", True, 200, 100, [25, 50, 100, 200], "B", None, None, None, "resources/DublinAirport.png"), 15)
		...
		s19 = Property("Dame Street",TitleDeedCard("Dame Street", True, 180, 90, [14, 70, 200, 550, 750, 950], "F", "orange", 100, 100, "resources/dame.png"), 18, False, None)
		...
		s26 = Station("Heuston Station", False, False, 200, TitleDeedCard("Heuston Station", True, 200, 100, [25, 50, 100, 200], "B", None, None, None, "resources/HeustonStation.png"), 25)
		...
		s36 = Station("Shannon Airport", False, None, 200, TitleDeedCard("Shannon Airport", True, 200, 100, [25,50,100,200], "B", None, None, None, "resources/ShannonAirport.png"), 35)
